...
<table>
  <tr align="center">
    <td width="50%"><b>채팅방 생성</b></td>
    <td width="50%"><b>메시지 전송</b></td>
  </tr>
  <tr align="center">
    <td><img src="https://github.com/user-attachments/assets/843e9a11-3d16-42a0-816f-542247ef2e14" width="100%" alt="채팅방 생성 API"></td>
    <td><img src="https://github.com/user-attachments/assets/6db6c3f5-c2cb-42bb-989f-8cc4142075db" width="100%" alt="메시지 전송 API"></td>
  </tr>
  <tr align="center">
    <td width="50%"><b>메시지 목록 조회</b></td>
    <td width="50%"><b>안 읽은 메시지 수 조회</b></td>
  </tr>
  <tr align="center">
    <td><img src="https://github.com/user-attachments/assets/e5580dc5-9d84-4f7a-a7f2-205bca93a7fd" width="100%" alt="메시지 목록 조회 API"></td>
    <td><img src="https://github.com/user-attachments/assets/8a200947-1158-41d5-9dc5-275f7d9fcf90" width="100%" alt="안 읽은 메시지 수 조회 API"></td>
  </tr>
  <tr align="center">
    <td colspan="2"><b>메시지 읽음 처리</b></td>
  </tr>
  <tr align="center">
    <td colspan="2"><img src="https://github.com/user-attachments/assets/7050bb16-b6a9-406c-8857-1837c3e8adea" width="50%" alt="메시지 읽음 처리 API"></td>
  </tr>
</table>
